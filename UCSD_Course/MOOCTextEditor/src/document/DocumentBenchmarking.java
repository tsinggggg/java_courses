...
public class DocumentBenchmarking {
	...
	public static void main(String [] args) {
				...
				numToCheck += increment)
		{
			 ...
			 */  
			 System.out.print("numToCheck is "+Integer.toString(numToCheck)+"\t");
			 
			 String s = getStringFromFile(textfile,numToCheck);
			 
			 long t1 = System.nanoTime();
			 for (int i=0;i<trials;i++) {
				 Document bd = new BasicDocument(s);
			 ...
			 System.out.print(Double.toString(t)+'\t');
			 
			 t1 = System.nanoTime();
			 for (int i=0;i<trials;i++) {
				 Document bd = new EfficientDocument(s);
				 double score = bd.getFleschScore();
			 }
			 t2 = System.nanoTime();
